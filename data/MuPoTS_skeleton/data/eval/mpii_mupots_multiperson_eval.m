...
%% load prdictions
preds_2d_kpt = load('/local_scratch/wguo/repos/3DMPPE/posenet/output/result/preds_2d_kpt_mupots.mat');
preds_3d_kpt = load('/local_scratch/wguo/repos/3DMPPE/posenet/output/result/preds_3d_kpt_mupots.mat');
...
if(EVALUATION_MODE == 0)
    out_prefix = 'eval_result/all_annotated_';
else
